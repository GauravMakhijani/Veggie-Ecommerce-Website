            ...
            <Row className="row ">
              ...
              <Col className="p-6">
                ...
                <p className="shop-now-p mt-4">
                  ...
                  investment in the future. By supporting local farmers today,
                  we are helping to ensure that there will be farms in our
                  community tomorrow!
                </p>
                <p className="shop-now-p">
                  We have 6 points quality control system that ensures that each
                  piece of fruits and vegetables should match Grade A Quality.
                  Our Logistics chain ensure each fruits and vegetables reaches
                  your doorsteps within 24 hours of plucking and harvesting.
                </p>
